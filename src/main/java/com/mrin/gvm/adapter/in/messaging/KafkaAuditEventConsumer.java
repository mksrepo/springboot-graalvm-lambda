...
public class KafkaAuditEventConsumer {
    ...
    private AuditLog mapToAuditLog(AuditEvent event) {
        return AuditLog.builder()
                ...
                .entityId(event.getEntityId() != null ? event.getEntityId().longValue() : null)
                ...
                .requestTimestamp(event.getRequestTimestamp() != null ? event.getRequestTimestamp().toInstant() : null)
                .completionTimestamp(
                        event.getCompletionTimestamp() != null ? event.getCompletionTimestamp().toInstant() : null)
                .durationMs(event.getDurationMs() != null ? event.getDurationMs().longValue() : null)
